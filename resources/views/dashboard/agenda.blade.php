  ...
  <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
    ...
    <div>
      ...
      <div class="col-12 d-flex">
        <h1 class="anchor fw-bolder mb-5" id="striped-rounded-bordered">Manage Agenda Kegiatan</h1>
        ...
        <table id="myTable" class="table table-striped table-hover table-rounded border gs-7">
          <thead>
            <tr class="fw-bold fs-6 text-gray-800 border-bottom border-gray-200">
              ...
              <th style="min-width: 100px">Link sumber</th>
            ...
            <tr>
              ...
              <td>
                <div class="symbol symbol-30px me-5" data-bs-toggle="modal" data-bs-target="#foto" onclick="foto('{{ $a->image }}')">
                  <img src="/assets/img/agenda/{{ $a->image }}" class="h-30 align-self-center of-cover rounded-0" alt="">
                </div>
                {{ $a->title }}  
              </td>
              <td><span class="badge badge-primary">{{ $a->city }}</span></td>
              <td>{{ $a->date }}</td>
              <td>{{ $a->price }}</td>
              <td>
                <a href="{{ $a->source }}" target="_blank">Klik disini</a>
              </td>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title">Tambah Agenda Kegiatan</h3>
...
<div class="modal fade" tabindex="-1" id="edit">
  <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h3 class="modal-title" id="et">Edit Agenda Kegiatan</h3>
          <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal" aria-label="Close">
            <i class="bi bi-x-lg"></i>
          </div>
        </div>
...
<div class="modal fade" tabindex="-1" id="hapus">
  <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h3 class="modal-title">Hapus Agenda Kegiatan</h3>
          <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal" aria-label="Close">
            <i class="bi bi-x-lg"></i>
          </div>
        </div>
        <form class="form" method="post" action="">
          ...
          <div class="modal-body text-center">
            ...
            <p class="mb-2 fs-4">Apakah anda yakin ingin menghapus Agenda Kegiatan ini?</p>
          </div>
          <div class="modal-footer">
            <button type="reset" class="btn btn-light me-3" data-bs-dismiss="modal">Batal</button>
...
<script type="text/javascript">
  ...
  function foto(image){
    $("#img-view").attr("src","/assets/img/agenda/"+image);
  }
  function edit(id){
    $.ajax({
      url: "/api/agenda/"+id,
